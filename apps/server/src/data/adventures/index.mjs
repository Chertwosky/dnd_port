...
export function buildThirteenMinutesAdventure() {
  ...
  return {
    ...
    description:
      "Эберрон · 5 героев (Катрисса, Дуулан, Геррит, Игнорина, Каркас) · молниевой поезд, Вторая Скорбь и выбор открытого мира. Карты + НПС + пул листов для выбора игроками.",
    level: 3,
    players: 5,
    duration: "4–6 часов",
    npcs,
    maps,
    notes: [
      "При применении шаблона в пул героев сразу добавляются 5 листов партии — игроки выбирают персонажа без своей заливки.",
